...
- Versão: `4.3.1` (parent `iped:iped-parent`).
...
- Javadocs em código legado estão majoritariamente em **português brasileiro**; Javadocs novos **DEVEM ser em inglês** (ver [CLAUDE.md](../CLAUDE.md) §4, "Idioma do código"). Ao reescrever substancialmente uma classe legada, traduzir o Javadoc do bloco afetado no mesmo PR. Edições triviais (rename, format) preservam o idioma original.
...
- [ ] Adicionou javadoc em **inglês**? Edição em classe legada com Javadoc PT-BR: trivial preserva, reescrita substancial traduz.
