...
- Regras com nomes iguais em arquivos diferentes: o namespace é derivado do arquivo de origem; o identificador exposto inclui namespace + nome, evitando colisão.
