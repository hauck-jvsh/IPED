...
- Três decisões de escopo foram confirmadas com o solicitante e codificadas como assumptions/requisitos: cut-over total para Java 21 (FR-017), sem preservar grafos antigos (FR-007), e migração preservadora de comportamento (FR-018).
