...
| Migração da API do Neo4j em `graph/` (engine + app) | Neo4j 4.4 não roda em Java 21; 5.x muda API e formato de store | Manter 4.4 impede Java 21; preservar store antigo foi descartado pelo solicitante (FR-007) |
