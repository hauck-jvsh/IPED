...
- **FR-044**: O sistema MUST comparar, antes de iniciar, o espaço livre no destino com uma estimativa do que o caso vai ocupar, e MUST declarar o resultado no aceite e registrá-lo na trilha quando o espaço for insuficiente. Essa verificação MUST NOT recusar o pedido: a decisão de seguir permanece com quem pediu. A estimativa MUST vir rotulada como estimativa.
...
- **SC-019**: 100% dos pedidos cujo destino tem menos espaço livre que a estimativa recebem a advertência no aceite e a registram na trilha, e 0% deles são recusados por essa razão.
